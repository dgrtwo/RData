...
```{r setup, echo=FALSE}
library(knitr)
opts_chunk$set(cache=TRUE, cache.path="lesson1/cache/", fig.path="lesson1/figures/")
...
```{r setup_objs, echo=FALSE}
test1 = 1
test2 = 2
test3 = 3
```

```{r, dependson="setup_objs"}
ls()
```
...
```{r rm_objs, dependson="setup_objs"}
rm(test1)
```
